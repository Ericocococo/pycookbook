#coding=utf-8
"""牛股王 ntquant 交易对象字段说明。
"""

from . import ntconstant as _NTCONST_
...
class StockAccount(object):
    ...
    def __new__(cls, account_id, account_type='STOCK'):
        ...
        :param account_type: 账号类型，默认 'STOCK'
    ...
    def __init__(self, account_id, account_type='STOCK'):
        """
        :param account_id: 资金账号
        :param account_type: 账号类型字符串，如 'STOCK', 'CREDIT', 'FUTURE' 等
        """
        account_type = account_type.upper()
        for int_type, str_type in _NTCONST_.ACCOUNT_TYPE_DICT.items():
...
class NtAsset(object):
    ...
    def __init__(self, account_id, cash, frozen_cash, market_value, total_asset, fetch_balance):
        ...
        """
        self.account_type = _NTCONST_.SECURITY_ACCOUNT
        self.account_id = account_id
        self.cash = cash
...
class NtCancelOrderResponse(object):
    """异步撤单请求响应。"""
...
class NtCreditOrder(NtOrder):
    """信用委托结构。"""
    pass


class NtCreditDeal(object):
    """信用成交结构。"""
    pass


class NtSmtAppointmentResponse(object):
    """约券预约响应。"""
    pass


class NtBankTransferResponse(object):
    """银证转账响应。"""
    pass


class NtSmartAlgoOrderResponse(object):
    """智能算法下单响应。"""
    pass


class NtOperateSmartTaskResponse(object):
    """智能算法任务操作响应。"""
    pass
