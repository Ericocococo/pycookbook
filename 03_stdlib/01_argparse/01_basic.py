...
真实使用时省略参数,parse_args() 默认读取 sys.argv（系统命令行参数列表）。
"""
import argparse
...
def build_parser() -> argparse.ArgumentParser:
    ...
    # 位置参数（positional argument）：必填,按顺序传,不带 - 前缀
    parser.add_argument("src", help="源文件路径")
    # 可选参数（optional argument）：带 - / -- 前缀,可省略;-o 是短选项,--output 是长选项
